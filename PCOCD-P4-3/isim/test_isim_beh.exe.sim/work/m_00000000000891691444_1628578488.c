...
#endif
static const char *ng0 = "C:/code/projects/MIPS-CPU/PCOCD-P4-3/bltzal_test.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static const char *ng3 = " *BLTZAL test started.";
...
static const char *ng12 = " *BLTZAL test finished.";
static int ng13[] = {5, 0};
